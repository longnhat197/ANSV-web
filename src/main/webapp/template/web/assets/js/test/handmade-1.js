			...
			if (!$(this).parent().hasClass("active"))
			{
				if (!motionIng)
				{
					...
					if (tabIdx == 0)
					{
						...
						$(".f02 .contents_ul > li").eq(1).animate({"margin-left":"100%"},motionDelay);
							
					}else{
						$(".f02 .contents_ul > li").eq(0).animate({"margin-left":"-100%"},motionDelay);
		...
		$(".f03 .video_wrap .carousel li").eq(idx).addClass("active");
			if (slide_t == "r")
			{
				if (f03sliderIdx == sliderSize)
				{
					...
					f03Slider.eq(sliderFull).stop().animate({"margin-left": "100%"},motionDelay, function(){
						f03Slider.eq(1).css({"margin-left":"-100%"});
						$(this).css({"margin-left":((sliderSize + 1) * 100) + "%"});
					});
					f03Slider.eq(sliderFull-1).stop().animate({"margin-left": "0%"},motionDelay, function(){
						f03Slider.eq(2).css({"margin-left":"0%"});
						$(this).css({"margin-left": ((sliderSize) * 100) + "%"});
					});
					f03Slider.eq(sliderFull-2).stop().animate({"margin-left": "-100%"},motionDelay, function(){
						f03Slider.eq(3).css({"margin-left":"100%"});
						$(this).css({"margin-left": ((sliderSize-1) * 100) + "%"});
					});
					f03Slider.eq(sliderFull-3).stop().animate({"margin-left": "-200%"},motionDelay, function(){
						f03Slider.eq(4).css({"margin-left":"200%"});
					...
					for (var i = 0;i <= sliderFull ; i++ )
					{
						...
						}else if (i > slide_idx + 2)
						{
							...
							f03Slider.eq(i).stop().animate({"margin-left":"0%"},motionDelay);
						}
					}
				}
			}else{
				if (f03sliderIdx == 0)
				{
					...
					f03Slider.eq(0).stop().animate({"margin-left": "-100%"},motionDelay, function(){
						f03Slider.eq(sliderFull-3).css({"margin-left":"-100%"});
						$(this).css({"margin-left":((sliderSize + 1) * 100) + "%"});
					});
					f03Slider.eq(1).stop().animate({"margin-left": "0%"},motionDelay, function(){
						f03Slider.eq(sliderFull-2).css({"margin-left":"0%"});
						$(this).css({"margin-left": ((sliderSize) * 100) + "%"});
					});
					f03Slider.eq(2).stop().animate({"margin-left": "100%"},motionDelay, function(){
						f03Slider.eq(sliderFull-1).css({"margin-left":"100%"});
						$(this).css({"margin-left": ((sliderSize-1) * 100) + "%"});
					});
					f03Slider.eq(3).stop().animate({"margin-left": "200%"},motionDelay, function(){
						f03Slider.eq(sliderFull).css({"margin-left":"200%"});
						$(this).css({"margin-left": ((sliderSize-2) * 100) + "%"});
					});
