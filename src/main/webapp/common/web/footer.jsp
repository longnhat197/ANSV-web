        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <p>
              ...
              Việt, Cầu Giấy<br>
              Hà Nội <br><br>
              <strong>Phone:</strong> 84 - 4 38362094<br>
          ...
          <div class="col-lg-2 col-md-6 footer-links">
            <h4>Liên kết</h4>
            <ul>
              <li><i class="bx bx-chevron-right"></i> <a href="trang-chu">Trang chủ</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="ve-chung-toi">Về chúng tôi</a></li>
